 ...
 * /cn/enaium/webrtc/agc2/native/linux-aarch64/, which NativeLoader
 * (in :agc2's jvmMain) extracts and System.load()s at runtime.
 *
 * Builds natively on aarch64 Linux and cross-compiles on x86_64 Linux with the
 * aarch64-linux-gnu toolchain (`apt-get install gcc-aarch64-linux-gnu
 * g++-aarch64-linux-gnu`).
 */
import java.io.File
