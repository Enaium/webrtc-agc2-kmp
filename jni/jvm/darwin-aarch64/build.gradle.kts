 ...
 * Ships libwebrtc_agc2_jni.dylib as a classpath resource at
 * /cn/enaium/webrtc/agc2/native/darwin-aarch64/, which NativeLoader
...
val libFile = "libwebrtc_agc2_jni.dylib"
...
val buildJniLibrary by tasks.registering(Exec::class) {
    group = "build"
    description = "Builds libwebrtc_agc2_jni.dylib for $classifier."
    onlyIf { canBuildHere }
